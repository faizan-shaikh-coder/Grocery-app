...
import dairyData from '../../productdata/dairy';
...
const Dairy = () => {
  ...
  const filtered = dairyData.filter(item =>
    item.name.toLowerCase().includes(query.toLowerCase())
  );
  
  return (
    <div className='p-4 max-w-7xl mx-auto'>
      <h2 className='text-2xl sm:text-3xl font-bold mb-4 text-green-700 text-center'>Dairy Products</h2>
